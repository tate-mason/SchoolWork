...
subplot(3, 2, 1);
plot(xgrid, k_no_100, 'b--', 'LineWidth', 1.5);
hold on;
...
subplot(3, 2, 2);
plot(xgrid, k_no_80, 'b--', 'LineWidth', 1.5);
hold on;
...
% 100% Survival: Wage
subplot(3, 2, 3);
plot(xgrid, w_no_100, 'b--', 'LineWidth', 1.5);
hold on;
...
% 80% Survival: Wage
subplot(3, 2, 4);
plot(xgrid, w_no_80, 'b--', 'LineWidth', 1.5);
hold on;
...
subplot(3, 2, 5);
plot(xgrid, welf_no_100, 'b--', 'LineWidth', 1.5);
hold on;
...
% 80% Survival: Welfare
subplot(3, 2, 6);
plot(xgrid, welf_no_80, 'b--', 'LineWidth', 1.5);
hold on;
