...
\subtitle{East et al. (AER 2023): Early Life Exposure to Medicaid and the Safety Net}
\author{Tate Mason}
...
\begin{frame}{Preview of findings}
  \begin{itemize}
    \item Those directly exposed the expansion saw higher probability of enrollment at birth
    \item First generation cohort reductions in likelihood of being born low birth weight
...
\begin{frame}{Treated vs control states (visual)}
\centering
...
\begin{frame}{Event-study design (technical slide)}
\small
...
\centering
  \includegraphics[height=0.78\textheight, width=\textwidth]{../Figures/fig_elig_birth.png}
\vspace{4pt}
\begin{itemize}
  \item As expansions settle nationally, eligibility nearly doubles and takeup increases by 5\%
\end{itemize}
\end{frame}
...
\begin{frame}{Mechanisms (high-level)}
\begin{itemize}
