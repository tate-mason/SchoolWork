...
Following \cite{CSA}, I estimate the following differences-in-differences  model:
\begin{equation}
...
I also apply the synthetic differences-in-differences method of \cite{arkhangelsky} to test for robustness of the results. This method creates a synthetic control group for each treated cohort by weighting the control states to match the pre-treatment trends of the treated states. This allows for a more flexible comparison between treated and control states, helping to address potential violations of the parallel trends assumption needed for the staggered differences-in-differences approach.
