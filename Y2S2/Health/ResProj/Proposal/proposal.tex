...
\Section{Data}
  ...
  Difficulties here include aggregation of state level data to city level. An idea to conquer this issue is to go from state to city/metro area by dividing the state participation population
  by weighted stratification, weighting based on amount of high schools in a city/metro area. This is imperfect, but just as an initial concept, seems feasible. Similarly, there is difficulty
  when linking health outcomes. IPUMS has indictors for if someone has difficulty caring for oneself as the only health related variable. This is obviously vague, and an extreme form of bad
  health. I am still, again, looking for a dataset that can remedy this.

\Section{Conclusion}
  Understanding how representation at a young age impacts long term outcomes is both interesting and worth investigating. In the domain of women's sports, there is ongoing debate about fair pay,
  especially in comparison to male counterparts. If the professionalization of female athletics has a significant impact on the outcomes of young female athletes, there may be credence to the 
  argument deserving a higher wage. This paper seeks to understand the extent to which uptake of youth sports in response to the US Women's National Soccer Team's and Women's National Basketball 
  Association's formation and ascent in the 1990's impacted both educational, labor outcomes, as well as health outcomes, for women. 
