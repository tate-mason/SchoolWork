...
* rename variables from all years to common names
...
*********** keep those variables we are going to use

#delimit ; 
keep year sample nhanes  bmi heightM 
weightKG  totfaminc pir crp systolic  diastolic  pulse hemoglobin ldl  hdl  cholesterol   sample_wts albumin  glycatedhemoglobin  triglycerides highgrade marital age sex race seqn psu strata live_births dmdhhsiz; 
sort seqn;
save nhanes99readyforstack, replace;
