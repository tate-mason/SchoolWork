* this program reads in the data from nhanes iii exam file;
...
* code at the end to keeo the variables we need;
    ...
    FILENAME EXAM "N:\TRANSFER\NHANES_III\EXAM.DAT" LRECL=6235;
...
* now keep the variables we need;

data out.exam_iii;
set work1;
keep seqn bmpwhr bmpwt bmpht bmpbmi;
run;
