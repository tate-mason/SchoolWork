...
regimes = [
    (1.5, 3.00, "β = 1.3, γ = 0.65", "-"),
    (1.5, 4.50, "β = 1.3, γ = 1.3", "--"),
    (1.5, 6.00, "β = 1.3, γ = 2.6", ":"),
    (2.0, 4.00, "β = 2.0, γ = 1.0", "-"),
    (2.0, 6.00, "β = 2.0, γ = 2.0", "--"),
    (2.0, 8.00, "β = 2.0, γ = 4.0", ":"),
    (3.0, 6.00, "β = 3.0, γ = 1.5", "-"),
    (3.0, 9.00, "β = 3.0, γ = 3.0", "--"),
    (3.0, 12.0, "β = 3.0, γ = 6.0", ":"),
]
