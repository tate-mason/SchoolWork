...
\begin{frame}{Literature Connections}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item Dub\'e, Hitsch, Rossi (2010): Habit formation and switching costs
        \item Bronnenberg, Dub\'e, Gentzkow (2012): Experience-based learning and consumer behavior
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
  ...
  \begin{tcolorbox}[colback=red!5!white, colframe=UGARed, title=\textbf{Contribution}]
    I build upon Chintagunta's dynamic demand model which micro-founds variety-seeking by using it to study how consumer preferences for novelty and habit shape consumption dynamics and firms' optimization strategies in a dynamic market. 
  \end{tcolorbox}
\end{frame}
...
\begin{frame}{Summary}
  \begin{enumerate}
    \item \hl{Model:} Consumer utility depends on deviation from
          experiences; nests variety-seeking and habit formation
...
\begin{frame}{References}
  \begin{thebibliography}{9}
    ...
    \bibitem{dube2010}
    Dub\'e, J. P., Hitsch, G. J., \& Rossi, P. E. (2010). \textit{Do switching costs make markets less competitive?} Journal of Marketing Research, 47(6), 965-982.
