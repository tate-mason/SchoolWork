...
\begin{frame}{Motivation: Data Privacy, Ad Targeting, and Consumer Agency}
  \begin{itemize}
    \item Concerns around data privacy and ad targetin
    \begin{itemize}
    ...
    \begin{itemize}
      \item $70\%$ of US e-commerce; $40\%$ of all retail
      \item Uses consumer data to target ads and build market share
    \end{itemize}
    \item Consumer agency over data (opt out)
    \begin{itemize}
      \item Apple iOS 14.5 update: $85\%$ opt-out rate
      \item Facebook ad revenue down $10\%$ in Q2 2022
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Addressing the Concern}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{itemize}
        \item How can we test the impact of policy interventions surrounding data privacy?
    ...
    \begin{column}{0.55\textwidth}
      \begin{itemize}
        ...
        \item These preferences shape consumer switching behavior, which in turn
              shapes firms' incentives to strategically target ads and promotions 
        \item Understanding the role of variety-seeking is crucial for modeling consumer behavior and evaluating the impact data privacy policies on both consumers and firms 
      \end{itemize}
    \end{column}
    \begin{column}{0.42\textwidth}
