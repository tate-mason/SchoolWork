...
\begin{frame}{Consumer Behavior with LOV}
  ...
  \end{tcolorbox}
  \begin{itemize}
    \item $\Sigma_{ijt} = X_{jt} - \theta_{it}$ captures the deviation of product $j$'s characteristic from consumer $i$'s previously chosen characteristics $\theta_{it}$ in period $t$.
