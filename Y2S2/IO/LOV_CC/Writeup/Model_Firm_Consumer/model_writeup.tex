...
Where $\pi(a) = (1 + a)p - c$ is the profit function, $\lambda(\gamma) \sim N(\frac{1}{\Sigma}, \sigma_{\lambda})$, and $\Sigma_j' = \Sigma_j + X_{jt}\cdot P_{ijt}$ is the updated sum of product attributes chosen by the consumer conditional on choosing product $j$ at time $t$.
