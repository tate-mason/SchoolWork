...
to find a new doctor, $V_a^f$, or to stay with their current match, $V_a^s$. $u(c_i)$ is the utility from consumption, with CRRA parameter $\sigma$. Risk evolves as before, and 
