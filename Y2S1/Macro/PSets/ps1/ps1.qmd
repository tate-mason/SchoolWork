...
As can be seen, there are overarching patterns which can be seen no matter how we slice the data. For instance, across all groups we see that
as the units approach age 60, labor hours fall, incomes rise, and variance of hours worked spikes. We see heterogeneity across hourly wages, with
unexpected results like blue collar workers earning more on an hourly basis and high school graduates who did not attend college exhibiting the same
behavior. Income is much more in line with expectation, with the wealthiest, most educated, and white collar units having more annualized income than
their counterparts in the sample. Labor force participation is about what should be expected, with those with higher education and wealth being consistently
