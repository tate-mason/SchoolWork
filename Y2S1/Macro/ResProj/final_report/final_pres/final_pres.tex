...
% Title page info
\title[Comfort or Cost?]{Wages vs Amenities in Mobility Decisions Later in Life}
...
\begin{frame}{Estimation Strategy}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item $\delta = [-1, 0, 1]$
    \end{itemize}
    \item Recover parameters: Moving cost parameter $\gamma$, $\delta$ for each group
    \item Simulated moments: age-specific moving rates and migration flow patterns
  \end{itemize}
\end{frame}
\begin{frame}{Preliminary Results}
  \begin{itemize}
    \item Estimated moving cost $\gamma = $ implies..
    \item Estimated $\delta =$ implies...
    \item Model estimates average moving rates for each group...
  \end{itemize}
\end{frame}
