...
When looking at the summary statistics for my data, I find some interesting patterns. Table 1 presents key statistics for three age groups: 40-50, 51-64, and 65+. As expected, average wages decline with age, from \$49,570 for the 40-50 group to just \$8,420 for the 65+ group. Gross rent also decreases with age, reflecting a potential downsizing in housing or relocation to lower-cost areas. Health care costs are only available for the 65+ group, averaging \$6,336 annually. Mobility rates increase with age, from 15\% for the 40-50 group to 20\% for the 65+ group, suggesting that older individuals may be more inclined to relocate, possibly for retirement or lifestyle reasons. Marital status shows a decline in marriage rates with age, from 61\% in the youngest group to 52\% in the oldest, perhaps due to death of spouse. Educational attainment also decreases with age, with college graduation rates dropping from 33\% in the 40-50 group to 25\% in the 65+ group, while high school graduation rates increase. This is likely due to cohort effects, as older generations had lower college attendance rates.
...
\hline
\hline
Statistic & 40--50 & 51--64 & 65+ \\
\hline
n & 5,640,580 & 6,999,381 & 5,241,806 \\
\hline
Average Age & 45.11 & 57.24 & 71.63 \\
            & (3.17) & (4.00) & (4.53) \\
\hline
Average Wages & 49,570.30 & 39,886.88 & 8,420.25 \\
              & (60,736.55) & (58,640.88) & (32,099.85) \\
\hline
Average Gross Rent & 245.43 & 161.14 & 112.20 \\
                   & (500.61) & (404.33) & (330.68) \\
\hline
Average Health Costs & -- & -- & 6,336.11 \\
                     & -- & -- & (1,291.34) \\
\hline
Mover \% & 15\% & 18\% & 20\% \\
Married \% & 61\% & 59\% & 52\% \\
...
\begin{tablenotes}
\footnotesize
\item Standard deviations are shown in parentheses beneath each mean.
\end{tablenotes}
