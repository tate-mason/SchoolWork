...
form_op <- as.formula("log_y2_next  ~ log_k_next + I(phi_hat - log_K) + bl_hat*log_L")
...
form_op_ind <- as.formula("log_y2_next ~ bl_hat*log_L:industry_factor + industry_factor + log_k_next:industry_factor + I(phi_hat - log_K:industry_factor)")
...
# Second stage for LP
form_lp <- as.formula("log_y2_next ~ bl_hat*log_L + log_k_next + log_M_next + I(phi_hat - log_K - log_M)")
