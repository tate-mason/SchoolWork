...
Changing the seed value does not change the overall results. Estimates for $\beta_D$ remain consistent within each part, and proportions of compliers/never-takers/always-takers remain similar. Correlations between $D$ and $Z$ also remain similar.
This shows the seed only effects reproducibility of the results, not the actual interpretation of results themselves.
...
While coefficient estimates remain similar, there is much more variability in proportions of compliers/never-takers/always-takers. Correlation between $D$ and $Z$ also varies more significantly, from about 0.6 to 0.9 depending on the seed value. This shows that smaller sample sizes lead to more variability in estimates and proportions, making it harder to draw reliable conclusions.
